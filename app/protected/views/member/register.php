                ...
                <tr valign="top">
                    <td>
                        <div>
                            ...
                            <?php //echo CHtml::radioButtonList('listname', $select,array('M' => 'Male', 'F' => 'Female'),  array('empty' => '(Select a gender)'));?>
                            <?php //echo $form->radioButton($model,'employee_sex',array('value'=>'m' , "checked" => "checked")) . 'ชาย'; ?>
                            <?php //echo $form->radioButton($model,'employee_sex',array('value'=>'f')) . 'หญิง'; ?>
                        </div>
                        <div>
                        ...
                        <div>
                        <?php echo $form->labelEx($model,"GroupSetting.group_name"); ?>
                    ...
                    <!-- <td>
                        <?php //echo GroupSetting::getOptions("Employee[group_id]", $model->group_id); ?>
                    </td> -->
                </tr>
                <tr>
